...
#         self.gpt2.train()
        ...
        # print('self.sampling_timesteps ',self.sampling_timesteps) 500
    ...
    def output(self, x, t, padding_masks=None):
        ...
        #  print('trend shape is :', trend.shape) # torch.Size([2001, 24, 7]
        # print('season shape is :', season.shape) # torch.Size([2001, 24, 7]
        
        model_output = trend + season
        # print('model_output shape is :', model_output.shape) # torch.Size([2001, 24, 7]
        # exit()
        return model_output
...
#         exit()        
    ...
    def forward(self, x, **kwargs):
        ...
        # print('x shape is :', x.shape)  # torch.Size([128, 24, 7]  # 224,24,1
